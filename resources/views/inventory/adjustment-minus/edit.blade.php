...
@section('content')
    ...
    <div id="content" class="content">
        {{ Breadcrumbs::render('adjustment_minus_edit') }}
        <!-- begin row -->
        <div class="row">
            <!-- begin col-12 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('adjustment-minus.update', $adjustmentMinus->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row" style="margin-bottom: 10px">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="kode" class="form-control" placeholder="Kode" id="kode"
                                        value="{{ $adjustmentMinus->kode }}" disabled readonly />
                                </div>
                                    ...
                                    <select name="gudang" class="form-control" required>
                                        @forelse ($gudang as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $adjustmentMinus->gudang_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama }}</option>
                                        @empty
