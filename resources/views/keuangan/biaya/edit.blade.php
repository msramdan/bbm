...
@section('title', trans('biaya.title.edit'))

@section('content')
    <!-- begin #content -->
    <div id="content" class="content">
        {{ Breadcrumbs::render('biaya_edit') }}
        <!-- begin row -->
        <div class="row">
                                    ...
                                    <select name="jenis_transaksi" class="form-control" id="jenis_transaksi" required>
                                        @foreach ($jenisTransaksi as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $biaya->jenis_transaksi == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="kas_bank" class="form-control" id="kas_bank" required>
                                        ...
                                        @foreach ($dicairkanKe as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $biaya->kas_bank == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    @error('kas_bank')
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="bank" class="form-control" id="bank" disabled>
                                        ...
                                        @foreach ($bank as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $biaya->bank && $biaya->bank->id == $item->id ? 'selected' : '-' }}>
                                                {{ $item->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="matauang" class="form-control" id="matauang" required>
                                        ...
                                        @foreach ($matauang as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $biaya->matauang_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama }}
                                            </option>
                                        @endforeach
                                    </select>
...
@include('keuangan.biaya.script.edit-js')
