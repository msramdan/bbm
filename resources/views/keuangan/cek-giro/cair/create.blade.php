...
@section('title', trans('cek_giro_cair.title.tambah'))

@section('content')
    <!-- begin #content -->
    <div id="content" class="content">
        {{ Breadcrumbs::render('cek_giro_cair_add') }}
        <!-- begin row -->
        <div class="row">
            <form action="{{ route('cek-giro-cair.store') }}" method="post">
                @csrf
                @method('post')
        ...
        $('#no_cek_giro').change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    setTimeout(() => {
                        jenis_cek_giro.val(data.jenis_cek)
