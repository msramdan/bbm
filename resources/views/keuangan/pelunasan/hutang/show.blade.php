...
@section('title', trans('pelunasan_hutang.title.show'))

@section('content')
    <!-- begin #content -->
    <div id="content" class="content">
        {{ Breadcrumbs::render('pelunasan_hutang_show') }}
        <!-- begin row -->
        <div class="row">
            <form>
                <!-- begin col-12 -->
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            ...
                            <h4>{{ trans('pelunasan_hutang.title.item_list') }}</h4>
                                ...
                                <table class="table table-striped table-condensed" id="tbl_trx">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($pelunasanHutang->pelunasan_hutang_detail as $item)
                                            ...
                                            @php
                                                $total_hutang += $item->pembelian->total_netto;
                                            @endphp
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>{{ number_format($total_hutang) }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                            ...
                            <h4>{{ trans('pelunasan_hutang.title.payment_list') }}</h4>
                            ...
                            <div class="form-group row" style="margin-bottom: 10px">
                                ...
                                <div class="col-md-4" style="margin-top: 1em;">
                                    ...
                                    <input type="text" name="bayar" id="bayar" class="form-control" placeholder="Bayar"
                                        value="{{ number_format($pelunasanHutang->bayar) }}" readonly />
                                </div>
