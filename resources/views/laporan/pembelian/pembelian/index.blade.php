...
@section('title', trans('dashboard.laporan.pembelian'))

@section('content')
    <!-- begin #content -->
    <div id="content" class="content">
        {{ Breadcrumbs::render('laporan_pembelian') }}
        <!-- begin row -->
        <div class="row">
            <!-- begin col-12 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{ trans('dashboard.laporan.pembelian') }}</h4>
                    </div>
                    <div class="panel-body">
                        <form action="{{ route('pembelian.laporan') }}" method="GET" style="margin-bottom: 1em;">
                            ...
                            @if (count($laporan) > 0)
                                <a href="{{ route('pembelian.pdf', request()->query()) }}" target="_blank"
