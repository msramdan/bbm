...
@section('title', trans('supplier.title.edit'))

@section('content')
    <!-- begin #content -->
    <div id="content" class="content">
        {{ Breadcrumbs::render('supplier_edit') }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="kode" class="form-control" placeholder="Kode"
                                        value="{{ old('kode') ? old('kode') : $supplier->kode }}" required disabled />
                                    @error('kode')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nama_supplier" class="form-control"
                                        ...
                                        value="{{ old('nama_supplier') ? old('nama_supplier') : $supplier->nama_supplier }}"
                                        required />
                                    @error('nama_supplier')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="npwp" class="form-control" placeholder="NPWP"
                                        value="{{ old('npwp') ? old('npwp') : $supplier->npwp }}" required />
                                    @error('npwp')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nppkp" class="form-control" placeholder="NPPKP"
                                        value="{{ old('nppkp') ? old('nppkp') : $supplier->nppkp }}" required />
                                    @error('nppkp')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="date" name="tgl_pkp" class="form-control" placeholder="Tanggal PKP"
                                        value="{{ old('tgl_pkp') ? old('tgl_pkp') : $supplier->tgl_pkp }}" required />
                                    @error('tgl_pkp')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea name="alamat" class="form-control" placeholder="Alamat" rows="8"
                                        required>{{ old('alamat') ? old('alamat') : $supplier->alamat }}</textarea>
                                    @error('alamat')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="kota" class="form-control" placeholder="Kota"
                                        value="{{ old('kota') ? old('kota') : $supplier->kota }}" required />
                                    @error('kota')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="kode_pos" class="form-control" placeholder="Kode Pos"
                                        value="{{ old('kode_pos') ? old('kode_pos') : $supplier->kode_pos }}" required />
                                    @error('kode_pos')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="telp1" class="form-control" placeholder="Telp 1"
                                        value="{{ old('telp1') ? old('telp1') : $supplier->telp1 }}" required />
                                    @error('telp1')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="telp2" class="form-control" placeholder="Telp 2"
                                        value="{{ old('telp2') ? old('telp2') : $supplier->telp2 }}" required />
                                    @error('telp2')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nama_kontak" class="form-control" placeholder="Nama Kontak"
                                        value="{{ old('nama_kontak') ? old('telp2') : $supplier->telp2 }}" required />
                                    @error('nama_kontak')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="telp_kontak" class="form-control" placeholder="Telp. Kontak"
                                        value="{{ old('telp_kontak') ? old('telp_kontak') : $supplier->telp_kontak }}"
                                        required />
                                    @error('telp_kontak')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="top" class="form-control" placeholder="TOP"
                                        value="{{ old('top') ? old('top') : $supplier->top }}" required />
                                    @error('top')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="status" class="form-control" required>
                                        ...
                                        <option value="N" {{ $supplier->status == 'N' ? 'selected' : '' }}>No</option>
                                    </select>
                                    @error('status')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
