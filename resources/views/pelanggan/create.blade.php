...
@section('title', trans('pelanggan.title.tambah'))
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{ trans('pelanggan.title.tambah') }}</h4>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('pelanggan.store') }}" method="post" novalidate>
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nama_pelanggan" class="form-control"
                                        placeholder="Nama Pelanggan" value="{{ old('nama_pelanggan') }}" required />
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Limit A/R</label>
                                <div class="col-md-9">
