...
@section('title', trans('penjualan.title.edit'))

@section('content')
    <!-- begin #content -->
    <div id="content" class="content">
        {{ Breadcrumbs::render('penjualan_edit') }}
        <!-- begin row -->
        <div class="row">
            <!-- begin col-12 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{ trans('penjualan.title.edit') }} - Header</h4>
                    </div>
                            ...
                            <div class="form-group row" style="margin-bottom: 10px">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="kode" class="form-control" placeholder="Kode" id="kode"
                                        value="{{ $penjualan->kode }}" required readonly />
                                </div>
                                    ...
                                    <select name="gudang" id="gudang" class="form-control" required>
                                        @forelse ($gudang as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $penjualan->gudang_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama }}</option>
                                        @empty
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="salesman" name="salesman" class="form-control" required>
                                        @forelse ($salesman as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $penjualan->salesman_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama }}</option>
                                        @empty
                                            <option value="" disabled>Data tidak ditemukan</option>
                                        @endforelse
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="matauang" id="matauang" class="form-control" readonly>
                                        <option value="{{ $penjualan->matauang_id }}">{{ $penjualan->matauang->kode }}
                                        </option>
                                    </select>
                                </div>
                                {{-- end col-md-2 --}}
                            ...
                            <div class="form-group row" style="margin-top: 1em;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="keterangan" id="keterangan" rows="5"
                                        class="form-control">{{ $penjualan->keterangan }}</textarea>
                                </div>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="row form-group" id="total" style="margin-top: 1em;">
                                    ...
                                    <div class="col-md-3" style="margin-top: 1em;">
                                        ...
                                        <input type="number" step="any" name="total_biaya_kirim" id="total_biaya_kirim"
                                            ...
                                            value="{{ $penjualan->total_biaya_kirim }}" />
                                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{ trans('penjualan.title.payment_list') }}</h4>
                    </div>
...
@include('penjualan.penjualan.script.edit-js')
